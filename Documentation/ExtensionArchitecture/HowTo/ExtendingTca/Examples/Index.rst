      ...
      [
         'tx_examples_options' => [
            ...
            'config' => [
               ...
               'items' => [
                  ['label' => '', 'value' => 0,],
                  ['label' => 'LLL:EXT:examples/Resources/Private/Language/locallang_db.xlf:fe_users.tx_examples_options.I.0', 'value' => 1,],
                  ['label' => 'LLL:EXT:examples/Resources/Private/Language/locallang_db.xlf:fe_users.tx_examples_options.I.1', 'value' => 2,],
                  ['label' => 'LLL:EXT:examples/Resources/Private/Language/locallang_db.xlf:fe_users.tx_examples_options.I.2', 'value' => '--div--',],
                  ['label' => 'LLL:EXT:examples/Resources/Private/Language/locallang_db.xlf:fe_users.tx_examples_options.I.3', 'value' => 3,],
               ],
               'size' => 1,
               'maxitems' => 1,
            ],
